...
def write_clonal_info(clonal_info_dico_unsorted,output_file,clonotype_dico):
	...
	##print ("clonal_info_dico_unsorted",clonal_info_dico_unsorted)
	#print("---------------------------------------------------------\n")
	#print("---------------------------------------------------------\n")
	#print("---------------------------------------------------------\n")
	#print("---------------------------------------------------------\n")
	#print("---------------------------------------------------------\n")
	#print("---------------------------------------------------------\n")
	##print("list_sorted_clonal_info",sorted(clonal_info_dico_unsorted.items(), key=lambda t: t[1][0],reverse=True)[0])
	clonal_info_dico = dict(sorted(clonal_info_dico_unsorted.items(), key=lambda t: t[1][0],reverse=True))
	##print("clonal_info_dico",clonal_info_dico)
	for clone in clonal_info_dico.keys():
		...
		#print("clonal_info_dico[clone][-1]",clonal_info_dico[clone][-1])
		#print("---------------------------------------------------------\n")
		#print("---------------------------------------------------------\n")
		#print("---------------------------------------------------------\n")
		sorted_clonotype = sorted(clonal_info_dico[clone][-1],key=lambda tup: float(tup[0]) ,reverse=True)
		###print("sorted",sorted_clonotype[0])
		for clonotype in  sorted_clonotype:
			phrase += " " + str(clonotype[0])+","+str(clonotype[1])
			print(str(clonotype[0])+","+str(clonotype[1]))
