...
def read_seq_info(lines,airr_dico):
...
#the most abundant seq ===> germline 
	...
	return clonotype_seq,germline

def compare_clonotype_to_germline(airr_dico,clonotype_seq,germline):
	clonotype_align = {}
	for key in clonotype_seq.keys():
...
#####################################################################
def main():
	usage = "usage: intraconal_alignment.py -a AIRR_IMGT_annotation_output -f final_seq_info -n repertoire_name"
	...
	clonotype_seq,germline = read_seq_info(lines_clonotype_seq,airr_dico)
	clonotype_align = compare_clonotype_to_germline(airr_dico,clonotype_seq,germline)
